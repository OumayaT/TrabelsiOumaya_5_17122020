...
recapDiv.innerHTML = `
    <div class="card mb-4 mb-lg-0 border-warning shadow">
        ...
        <div class="card-body">
            ...
            <h4 class="h6">Votre commande a été enregistrée. Un e-mail de confirmation vient de vous être envoyé.</h4>
            
            <p>Nous vous tienderons informés par e-mail lorsque votre commande sera expédiée.</p>
